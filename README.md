...
```bash
# Verify CLI is configured correctly
goploy config check

# Start MCP server (used by Claude/Cursor automatically)
goploy mcp
```

In Claude/Cursor, send a test prompt:
> "List all deployable projects"

### Full Installation Guide

For Docker, npm package and CI/CD setup, see [SKILL_INSTALL.md](./SKILL_INSTALL.md).
